...
export declare const preFix: (target: string | number, fix?: string | number) => string;
...
export declare const numberToLetterMulti: (num: string | number, symbol?: string, toUpper?: boolean) => string;
